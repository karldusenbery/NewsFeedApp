...
public class QueryUtils {
    ...
    static List<NewsArticle> fetchNewsData(String queryUrl, Context context) {
    ...
    private static List<NewsArticle> extractNews(String jsonResponse, Context context) {
            ...
            if(jsonObject.has(context.getString(R.string.response_object))){
                ...
                if(responseJSONObject.has(context.getString(R.string.results_array))) {
                    ...
                    for (int i = 0; i < resultsJSONArray.length(); i++) {
                        ...
                        newsArticles.add(new NewsArticle(title, section, publicationDateTime, webUrl, thumbnail, authors));
                    }
                }
            }
